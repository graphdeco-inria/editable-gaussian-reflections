...
int main() {
    ...
    std::cout << "USE_EPANECHNIKOV_KERNEL = "
              << "True"
              << "\n";
#else
    std::cout << "USE_EPANECHNIKOV_KERNEL = "
    ...
    std::cout << "ALLOW_OPACITY_ABOVE_1 = "
              << "True"
              << "\n";
#else
    std::cout << "ALLOW_OPACITY_ABOVE_1 = "
    ...
    std::cout << "REFLECTION_RAY_FROM_GT_NORMAL = "
              << "True"
              << "\n";
#else
    std::cout << "REFLECTION_RAY_FROM_GT_NORMAL = "
    ...
    std::cout << "REFLECTION_RAY_FROM_GT_POSITION = "
              << "True"
              << "\n";
#else
    std::cout << "REFLECTION_RAY_FROM_GT_POSITION = "
    ...
    std::cout << "SURFACE_BRDF_FROM_GT_F0 = "
              << "True"
              << "\n";
#else
    std::cout << "SURFACE_BRDF_FROM_GT_F0 = "
    ...
    std::cout << "SURFACE_BRDF_FROM_GT_ROUGHNESS = "
              << "True"
              << "\n";
#else
    std::cout << "SURFACE_BRDF_FROM_GT_ROUGHNESS = "
    ...
    std::cout << "REFLECTIONS_FROM_GT_GLOSSY_IRRADIANCE = "
              << "True"
              << "\n";
#else
    std::cout << "REFLECTIONS_FROM_GT_GLOSSY_IRRADIANCE = "
    ...
    std::cout << "PROJECT_POSITION_TO_RAY = "
              << "True"
              << "\n";
#else
    std::cout << "PROJECT_POSITION_TO_RAY = "
    ...
    std::cout << "REFLECTION_VALID_NORMAL_MIN_NORM = "
    ...
    std::cout << "SKIP_BACKFACING_NORMALS = "
              << "True"
              << "\n";
#else
    std::cout << "SKIP_BACKFACING_NORMALS = "
              ...
              << "\n";
#endif
    std::cout << "SKIP_BACKFACING_REFLECTION_VALID_NORMAL_MIN_NORM = "
    ...
    std::cout << "RELU_INSTEAD_OF_SOFTPLUS = " << RELU_INSTEAD_OF_SOFTPLUS
              << "\n";
    std::cout << "CLIPPED_RELU_INSTEAD_OF_SIGMOID = "
              << CLIPPED_RELU_INSTEAD_OF_SIGMOID << "\n";
}
