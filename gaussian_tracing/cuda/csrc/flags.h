...
#define REFLECTION_VALID_NORMAL_MIN_NORM 0.7f // higher leads to fewer invalid rays, but to black outlines
...
#define MAX_ITERATIONS 99 // n.b. ignored when REMAINING_COLOR_ESTIMATION == RENDER_BUT_DETACH
...
// n.b. writing all maps to memory can several ms per frame and should not be done at inference
...
#define SELF_SUPERVISED_POSITION_GRADS false //  interaction between using gt normals and self-supervised grads? need to disable the grads?
#define SELF_SUPERVISED_NORMAL_GRADS false //  interaction between using gt normals and self-supervised grads? need to disable the grads?
#define SELF_SUPERVISED_F0_GRADS false //  interaction between using gt normals and self-supervised grads? need to disable the grads?
#define SELF_SUPERVISED_ROUGHNESS_GRADS false //  interaction between using gt normals and self-supervised grads? need to disable the grads?
...
#define USE_GT_DIFFUSE_IRRADIANCE false // n.b. this is a placeholder for future work
...
// Preset configurations
    ...
    #define EXP_POWER 2
    #define ALPHA_THRESHOLD 0.01f 
    #define REMAINING_COLOR_ESTIMATION NO_ESTIMATION // using our estimate propbably changes nothing but can only improve psnr
#elif CONFIG == 11 // TMP
    // #define BBOX_PADDING 0.002f 
#elif CONFIG != -1
