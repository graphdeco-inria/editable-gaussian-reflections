...
if __name__ == "__main__":
    ...
    parser.add_argument("--edit", type=str, choices=["make_mirror", "make_bright", "delete", "make_rougher", "turn_pink"], default="make_mirror")
    ...
    mask = (torch.load(model_params.model_path + f"/select_{args.mask_name}.pt") > args.selection_threshold).squeeze(-1)
    ...
    with torch.no_grad():
        ...
        mask = (torch.load(model_params.model_path + f"/select_shelf.pt") > args.selection_threshold).squeeze(-1)
