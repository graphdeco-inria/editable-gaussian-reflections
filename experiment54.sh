...
bash run.sh --raytracer_version v15_1bounce_noblur -s colmap/shiny_bedroom --glossy_loss_weight 0.001 -m output_exp54/tonemapped+no_extra_gaussians_with_densif_pruning --num_farfield_init_points 0
