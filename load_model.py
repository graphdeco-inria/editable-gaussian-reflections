...
T = np.array([-2.53716236e-11, -6.97627801e-09, 1.92176780e00])
R = np.array(
    [
        [9.99989839e-01, 2.29605934e-03, -3.87952831e-03],
        [4.50806260e-03, -5.09317711e-01, 8.60566759e-01],
        [-1.34420959e-10, -8.60575503e-01, -5.09322887e-01],
    ]
)
camera_colmap = Camera(
    0,
    R,
    T,
    0.6911121570925639,
...
R = np.array(
    [
        [0.9999898672103882, -0.002296059625223279, 0.00387952895835042],
        [0.004508062731474638, 0.5093177556991577, -0.8605669140815735],
        [-2.3283064365386963e-10, 0.8605756163597107, 0.509323000907898],
    ]
)
camera = Camera(
    0,
